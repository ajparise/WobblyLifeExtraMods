...
An extension plugin for the installed **lstwoMODS Wobbly Life** mod menu. Version 1.16.1 adds these panels to the existing **Extra Mods** page:
...
Check `<Wobbly Life>\BepInEx\LogOutput.log` for `Wobbly Life Extra Mods 1.16.1 loaded`. If a searchable panel is empty, wait for the lstwoMODS asset scan to finish and click its refresh button.
