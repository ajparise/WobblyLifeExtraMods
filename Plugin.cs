...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    private void OnGUI()
    {
        ...
        ChaosWandMod.DrawCrosshair();
        PortalGunMod.DrawCrosshair();
        LightningGunMod.DrawCrosshair();
        WobblyHeadHomingGunMod.DrawCrosshair();
        BananaPeelLauncherMod.DrawCrosshair();
    }
